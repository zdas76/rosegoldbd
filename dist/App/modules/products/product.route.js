...
route.post("/", validationRequiest(ProductValidation.CreateProductValidationSchema), ProductControllers.createProduct);
route.get("/:id", ProductControllers.getProductById);
route.get("/", ProductControllers.getAllProduct);
route.put("/:id", validationRequiest(ProductValidation.updateProductValidationSchema), ProductControllers.updateProductById);
