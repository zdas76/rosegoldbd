...
route.post("/", validationRequiest(partyValidaton.createParty), PartyControllers.createParty);
...
route.put("/:id", validationRequiest(partyValidaton.UpdateParty), PartyControllers.updatePartyById);
